...
if __name__ == '__main__':
	...
	pts = gen_points(n, m, 1e-3, 12e-3)
	
	polys = gen_polys(n, m)

	material = assign_material(pts, polys)

	# print_vtk(pts, polys, material)
